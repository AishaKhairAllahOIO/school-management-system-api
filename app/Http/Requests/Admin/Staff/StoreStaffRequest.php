...
class StoreStaffRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
         ...
         'service_type'     => ['required_if:role,service_staff', 'nullable', 'string', 'in:cleaner,guard,driver,maintenance,kitchen_staff'], 
    ...
    {
        return [
            'password.required_if' => 'كلمة المرور إجبارية للمناصب الإدارية والتوجيهية (مدير، موجه، أمين سر).',
            'role.in'              => 'الدور الوظيفي المحدد غير صالح في النظام.',
        ];
    }
}